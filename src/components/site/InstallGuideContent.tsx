...
/** Содержимое инструкции «Установка приложения» — используется и внутри модального
 * окна (InstallGuide, открывается по кнопке в шапке), и на отдельной странице
 * /install (открывается по реферальной ссылке друга, см. src/pages/Install.tsx). */
const InstallGuideContent = ({ defaultTab = "ios" }: Props) => {
  ...
  const rawReferralUrl = referralCode
...
export default InstallGuideContent;